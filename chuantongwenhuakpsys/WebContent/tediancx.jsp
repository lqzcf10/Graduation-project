...
HashMap ac = (HashMap)dao.select("select * from tedian where id="+id).get(0);
%>
<!--[if lte IE 9]>
...
<jsp:include page="menu.jsp"></jsp:include>
  ...
  <div class="dy-container">
    ...
    <div class="dy-g">
      <div class="dy-u-md-8 dy-u-sm-12" style="width: 1100px;min-height: 330px;">
          <div class="tf-content" >
          <div style="text-align: center;">
              <h1 class="tf-title" style="margin-top: 10px;"><%=ac.get("name") %></h1>
              <p class="tf-icon" style="padding-top: 0px;">
                  <span class="dy-icon-clock-o"></span><%=ac.get("savetime") %>&nbsp;&nbsp;
                  
                 <!--   <span class="dy-icon-eye"></span> 1,012-->
               </p>
               <img  alt="" src="/chuantongwenhuakpsys/upfile/<%=ac.get("filename") %>" style="width: 660px;height: 300px;">
             </div>
               <div class="neirong">
                    <%=ac.get("content") %>
               </div>
