...
String url="/chuantongwenhuakpsys/lishilistqt.jsp?1=1";
...
<jsp:include page="menu.jsp"></jsp:include>
  ...
  <div class="dy-container">
    <ol class="dy-breadcrumb">
      ...
      <li class="dy-active">名句赏析</li>
    </ol>
    
    <div id="banner" class="dy-container" style="margin-bottom: 10px;padding-left: 0px;">
		<form action="/chuantongwenhuakpsys/lishilistqt.jsp" method="post">
   ...
   <div class="dy-g" style="border:0px solid red;min-height: 330px; ">
      ...
      <%for(HashMap map:alist){ %>
          <div class="dy-cf item">
              ...
              <a href="lishicx.jsp?id=<%=map.get("id") %>">
              ...
              <div class="jd-item-right">
             	 <h1 style="overflow:hidden;"><a href="lishicx.jsp?id=<%=map.get("id") %>"> <%=map.get("name") %></a> <b style="float: right;color: gray;"><%=map.get("savetime") %></b></h1>
