...
<jsp:include page="menu.jsp"></jsp:include>
  ...
  <div class="dy-container">
   <ol class="dy-breadcrumb">
      ...
      <li class="dy-active">用户注册</li>
    </ol>
    <form action="<%=path %><%=path %>?ac=memberReg" method="post" name="f1" id="f1">
   <div  style="text-align:left; border:0px solid red;background: white;">
                 
                 <div class="top" style="border:0px solid blue;">
					<h2 style="text-align: center;height: 100px;line-height: 100px;font-weight: bold;font-size:28px;letter-spacing: 10px;">用户注册</h2>
				 </div>
				 <%--<div  style="height: 150px;padding-top: 5px;margin-left: 100px;">
					   <table border="0">
					    <tr>
					      <td width="120">
					       <img alt="" id="imgfilename" src="/chuantongwenhuakpsys/upfile/no.jpg" width="100" height="100">
			               <input  name="filename"  type='hidden' class="form-control" placeholder="点击按钮上传图片"  required    id='url'  size='40'  />&nbsp;
				...
				--%><div class="top" style="border:0px solid blue">
					...
					<input type="text" name="uname" id="uname" placeholder="用户名" onblur="validatorloginName()" style="height: 40px;border-radius:2px 2px;border:1px solid #DCDCDC;width: 70%;padding-left: 10px;" required>
				</div> 	
				
				
				<div class="top"> 	
					<label style="border:0px solid red;width: 100px;"></label>
					<input type="password" name="upass" id="upass" placeholder="密码" pattern="(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,}" oninvalid="setCustomValidity('密码字母或数字组成长度6位以上')" oninput="setCustomValidity('');" style="height: 40px;border-radius:2px 2px;border:1px solid #DCDCDC;width: 70%;padding-left: 10px;" required> 
				</div>
				
				
				<div class="top"> 	
					<label style="border:0px solid red;width: 100px;"></label>
					<input type="text" name="tname" id="tname" placeholder="姓名" style="height: 40px;border-radius:2px 2px;border:1px solid #DCDCDC;width: 70%;padding-left: 10px;" required> 
				</div>
				...
				<div class="top"> 	
					<label style="border:0px solid red;width: 100px;"></label>
					<input type="text" name="tel" id="tel" placeholder="联系方式" style="height: 40px;border-radius:2px 2px;border:1px solid #DCDCDC;width: 70%;padding-left: 10px;" required> 
				</div>
				
				
				
					<input class="top" style="width: 12%;height:40px; background:#198cc1; margin-left: 10%;color:white;margin-bottom: 10%;" type="submit" value="注册" id="submit" name="submit" onclick="check()">
...
function validatorloginName(){     
	 ...
	 $.ajax({  
	        type: "POST",      
	         url: "/chuantongwenhuakpsys/chuantongwenhuakpsys?ac=membercheck", //servlet的名字     
	          data: "uname="+uname, 
...
<script type="text/javascript">
 ...
 $('#btnulTupian').uploadify({  
			                'formData': { 'folder': '/chuantongwenhuakpsys/Upload' },  
			                'buttonText': '选择照片',  
			                'buttonClass': 'browser',  
			                'removeCompleted': true,  
			                'swf': '/chuantongwenhuakpsys/uploadifyv3.1/uploadify.swf', 
			                ...
			                'uploader': 'uploadImg.action',
			                 ...
			                 'onUploadSuccess':function(file, data, response){
                                 $("#filename").val("/chuantongwenhuakpsys/upfile/"+file.name);
                                 $("#showimg").attr("src","/chuantongwenhuakpsys/upfile/"+file.name);
			                  }
			             });
});
