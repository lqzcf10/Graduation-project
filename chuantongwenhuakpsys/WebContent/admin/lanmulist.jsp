...
String hql="select * from lanmu where 1=1 and delstatus=0";
String url="/chuantongwenhuakpsys/admin/lanmulist.jsp?1=1";
...
%>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>项目类型<span class="c-gray en">&gt;</span> 项目类型 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
   <form action="/chuantongwenhuakpsys/admin/lanmulist.jsp">
   <div class="text-c"> 
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	    <span class="l"> 
	                      ...
	                      <i class="Hui-iconfont">&#xe600;</i>  添加信息</a></span>
	                     <span class="r">
	...
	<table class="table table-border table-bordered table-bg">
		...
		for(HashMap n:list){
		 ...
		 <tr class="text-c">
				<td><%=n.get("name") %></td>
				<td class="td-manage">
				 <a title="编辑" href="/chuantongwenhuakpsys/admin/lanmuedit.jsp?id=<%=n.get("id") %>" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i>编辑</a>
				 <a title="删除" href="javascript:void(0)"  class="ml-5" style="text-decoration:none" onclick="if(confirm('是否删除？')){location.replace('<%=path %><%=path %>?ac=lanmuDel&id=<%=n.get("id") %>');}"><i class="Hui-iconfont"></i>删除</a>
				 </td>
			</tr>
	   <%} %>
		</tbody>
...
function admin_add(title,url,w,h){
	window.location.href="/chuantongwenhuakpsys/admin/lanmuadd.jsp"
}
/*管理员-删除*/
