...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=feiyiedit&id=<%=id %>" method="post">
	 <input type="hidden" name="type" value=""/>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图片：</label>
		<div class="formControls col-xs-8 col-sm-9" >
               <input  name="filename" value="<%=map.get("filename") %>" type='text' class="input-text" placeholder="点击按钮上传图片"  required    id='url' style="width: 800px;" />&nbsp;
			   <input type='button' value='上传图片'  class="layui-input" onClick="upp('url')" style="width: 70px;height: 20px;border:1px solid #cccccc;background: white;border-radius:20px 20px;outline:none;"/>
		</div>
	</div>
