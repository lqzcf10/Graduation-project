...
<%
	...
	HashMap map = dao.select("select * from xiangmu where id="+id).get(0);
	HashMap lmmap = dao.select("select * from lanmu where id="+map.get("lmid")).get(0);
...
<article class="page-container">
	...
	<div class="row cl">
		...
		<img alt="" id="imgfilename" src="/chuantongwenhuakpsys/upfile/<%=map.get("filename") %>" width="300" height="100">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" >
		<ul>
		  <li><input type="text" class="input-text"  placeholder="名称" value="<%=map.get("title") %>"  id="title" name="title"  required></li>
		  <li id="msgLi"></li>
		</ul>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" >
		<ul>
		  <li><input type="text" class="input-text"  placeholder="类型" value="<%=lmmap.get("name") %>"  id="title" name="title"  required></li>
		  <li id="msgLi"></li>
		</ul>
		</div>
	</div>
