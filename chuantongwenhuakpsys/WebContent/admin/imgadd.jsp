...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=imgAdd" method="post">
	 <input type="hidden" name="type" value=""/>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图片：</label>
		<div class="formControls col-xs-8 col-sm-9" >
		       <img alt="" id="imgfilename" src="/chuantongwenhuakpsys/upfile/no.jpg" width="400" height="200">
               <input  name="filename"  type='hidden' class="form-control" placeholder="点击按钮上传图片"  required    id='url'  size='40'  />&nbsp;
			   <div style="margin-top: 10px;">
			   <input type='button' value='上传图片'  class="layui-input" onClick="up('url')" style="width: 70px;height: 20px;border:1px solid #cccccc;background: white;border-radius:20px 20px;outline:none;"/>
				</div>
		</div>
	</div>
