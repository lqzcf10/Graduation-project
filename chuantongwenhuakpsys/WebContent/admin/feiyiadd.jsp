...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=feiyiAdd" method="post">
	 <input type="hidden" name="type" value=""/>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>图片：</label>
		<div class="formControls col-xs-8 col-sm-9" >
               <input  name="filename"  type='text' class="input-text" placeholder="点击按钮上传图片"  required    id='url'  style="width: 800px;"  />&nbsp;
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9" >
		<ul>
		  <li><input type="text" class="input-text"  placeholder="名称"  id="title" name="title"  required></li>
		  <li id="msgLi"></li>
		</ul>
		</div>
	</div>
