...
<%
	...
	HashMap map = dao.select("select * from lanmu where id="+id).get(0);
...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=lanmuEdit" method="post">
	...
	<div class="row cl">
		...
		<ul>
		  <li><input type="text" class="input-text"  placeholder="名称" value="<%=map.get("name") %>"  id="name" name="name"  required></li>
		  <li id="msgLi"></li>
		</ul>
		</div>
	</div>
