...
<%
    ...
    if(null == saveurl||"".equals(saveurl)){
    	...
    	try{
    		...
    		e.printStackTrace();
    		System.out.println("upfile file error ...");
    		//content = "上载文件出现异常!";
    		//flagStr = "Fail";
    		return;
    	}
...
<script language="javascript">
	...
	var urlstr = window.parent.document.getElementById(Result).value+"<%= newFile1Name%>,"
	window.parent.document.getElementById(Result).value=urlstr;					
