...
<%
	...
	HashMap map = dao.select("select * from lishi where id="+id).get(0);
...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=lishiedit&id=<%=id %>" method="post">
