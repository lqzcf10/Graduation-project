...
<%
	...
	try 
	{
		mySmartUpload.setAllowedFilesList("jpg,png,jpeg,gif,mp4,avi");
...
<script language="javascript">
	...
	window.parent.document.getElementById("imgfilename").src="/chuantongwenhuakpsys/upfile/"+"<%= newFile1Name%>";				
