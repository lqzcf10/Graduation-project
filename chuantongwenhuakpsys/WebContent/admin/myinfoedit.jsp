...
HashMap s = (HashMap)dao.select("select * from sysuser where id="+admin.get("id")).get(0);
%>
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=adminEdit&id=<%=s.get("id") %>" method="post">
	<div class="row cl">
	...
	<%--<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="password" class="input-text"  placeholder="密码"  id="userpwd" name="userpwd" value="<%=s.getUserpwd() %>" required>
		</div>
	</div> 
	--%>
	<div class="row cl">
