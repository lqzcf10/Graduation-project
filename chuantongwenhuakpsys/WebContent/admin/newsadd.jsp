...
<article class="page-container">
	<div style="width: 400px;">
	 <form class="form form-horizontal" id="form-admin-add"  action="<%=path %><%=path %>?ac=newsAdd" method="post">
	...
	<div class="row cl">
		...
		<ul>
		  <li><input type="text" class="input-text"  placeholder="标题"  id="title" name="title"  required></li>
		  <li id="msgLi"></li>
		</ul>
		</div>
	</div>
